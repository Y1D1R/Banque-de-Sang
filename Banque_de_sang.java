...
public class Banque_de_sang {
	...
	static Mini_stock Stock_O_n = new Mini_stock(Groupe_Sanguin.O_negatif);
	static Mini_stock Stock_A_p = new Mini_stock(Groupe_Sanguin.A_positif);
	static Mini_stock Stock_A_n = new Mini_stock(Groupe_Sanguin.A_negatif);
	static Mini_stock Stock_B_p = new Mini_stock(Groupe_Sanguin.B_positif);
	static Mini_stock Stock_B_n = new Mini_stock(Groupe_Sanguin.B_negatif);
	static Mini_stock Stock_AB_p = new Mini_stock(Groupe_Sanguin.AB_positif);
	static Mini_stock Stock_AB_n = new Mini_stock(Groupe_Sanguin.AB_negatif);
	...
	{
		System.out.println("genre erron�!!! \n");
		etiq_genre();
	}
	return gnr;
	}
	...
	System.out.print("\n Groupe sanguin[O_positif,O_n�gatif,A_positif,A_n�gatif,B_positif,B_n�gatif,AB_positif,AB_n�gatif] : "); 
	...
	{
		System.out.println("groupe sanguin erron�!!! \n");
		etiq_groupe_sanguin();
	}
	return gr;
	}
	...
	public void ajout_donneur()
	{
		...
		System.out.println("Donneur ajout� avec succ�s \n\n");
	}
	...
	public void supprimer_donneur()
	{
		...
		if(d==null)
		{
			System.out.println("Num�ro du donneur inexistant !! \n");
		}
		else {
		liste_donneur.remove(d);
		System.out.println("Donneur supprim� avec succ�s \n ");
		}
	}
	...
	public void traitement_demande()
	{
		...
		String rep;
		System.out.println("=================================================================\n");
		System.out.println("Saisissez le numero du donneur ayant effectu� la demande");
		int nums = sc.nextInt();
		...
		if(dem==null)
		{
			System.out.println("Demande Introuvable pour le num�ro du donneur saisi \n\n");
		}
		else
		{
		...
		if(rep.equals("R"))
		{
			System.out.println("La demande de "+ dem.donneur.NomComplet + " faite le " + dem.date + " est rejet�e \n\n");
			demandes_don.remove(dem);
		}
		else if(rep.equals("A"))
		{
			
			System.out.println("La demande de "+ dem.donneur.NomComplet + " faite le " + dem.date + " est accept�e \n\n");
	...
	private void ajouter_au_stock(Demande_don dem)
	{
		...
		if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.O_positif))
		{
			...
			if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.O_negatif))
			{
				...
				if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.A_positif))
				{
					...
					if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.A_negatif))
					{
						...
						if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.B_positif))
						{
							...
							if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.B_negatif))
							{
								...
								if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.AB_positif))
								{
									...
									if(dem.donneur.groupe_sanguin.equals(Groupe_Sanguin.AB_negatif))
									{
	...
	public void afficher_donneurs()
	{
		...
		for(int i = 0 ; i < liste_donneur.size() ; i++ )
		{
			...
			System.out.println("Num�ro du donneur : "+liste_donneur.get(i).num_seq);
	...
	public void afficher_Stock()
	{
		...
		System.out.println("\n Nombre total de poches [A_n�gatif]= " + an);
		System.out.println("\n Nombre total de poches [B_positif]= " + bp);
		System.out.println("\n Nombre total de poches [B_n�gatif]= " + bn);
		System.out.println("\n Nombre total de poches [O_positif]= " + op);
		System.out.println("\n Nombre total de poches [O_n�gatif]= " + on);
		System.out.println("\n Nombre total de poches [AB_positif]= " + abp);
		System.out.println("\n Nombre total de poches [AB_n�gatif]= " + abn + "\n\n");
	}
	...
	public void afficher_demandes_don()
	{
		...
		for ( int i = 0 ; i < demandes_don.size() ; i++)
		{
			System.out.println("le num�ro du donneur "+demandes_don.get(i).donneur.num_seq);
	...
	public void Traitement_demandes_sang()
	{
		...
		System.out.println("=================================================================\n");
		sc.nextLine();
		System.out.println("Donnez le nom du patient ayant effectu� la demande !");
				...
				
			{
				...
				if(dd==-1)
				{
					...
					if(ff.equals(Groupe_Sanguin.A_positif)==true) 
					{
						...
						if(ap<demande_sang.get(i).nb_poches) {
							...
							System.out.println("Le don est effectu� le stock est mis a jour!!");
							System.out.println("La liste des dons fait avec succ�s est mise A Jour!! \n\n");
							
					}
					
				    }
					
					if(ff.equals(Groupe_Sanguin.A_negatif)==true) 
					{
					...
					if(ff.equals(Groupe_Sanguin.O_negatif)==true) 
					{
					...
					if(ff.equals(Groupe_Sanguin.B_negatif)==true) 
					{
					...
					if(ff.equals(Groupe_Sanguin.AB_negatif)==true) 
					{
						...
						if(abn<demande_sang.get(i).nb_poches) {
							...
							{
							System.out.println("Cette demande ne peut pas etre accept�e!!!");	
							}
				...
				else // SI LE NOM DU DONNEUR EST DIFFERENT DE "///"
				{
					...
					if(ff1.equals(Groupe_Sanguin.A_positif)==true) 
					{
						...
						while(y<Stock_A_p.liste.size() && trv==false)
						{
							if(Stock_A_p.liste.get(y).num==numd)
							{
							    if(Stock_A_p.liste.get(y).nb_poches>demande_sang.get(i).nb_poches)
							    {
							    	...
							    	if(Stock_A_p.liste.get(y).nb_poches<demande_sang.get(i).nb_poches)
							        {
							         	System.out.println("Le don ne peut pas etre valid�! Le nombre de poches donn�es par le donneur est insuffisant \n\n");
							         	demande_sang.remove(i);
							        } else
							    	   if(Stock_A_p.liste.get(y).nb_poches==demande_sang.get(i).nb_poches)
							    	   {
						...
						if(trv==false)
						{
							System.out.println("Aucun don pour le donneur saisi ! Demande Refus�e !\n\n");
							demande_sang.remove(i);
						}
					...
					//A_NEGATIF
					if(ff1.equals(Groupe_Sanguin.A_negatif)==true) 
					{
					...
					//O_n�gatif
					if(ff1.equals(Groupe_Sanguin.O_negatif)==true) 
					{
					...
					//B_NEGATIF
					if(ff1.equals(Groupe_Sanguin.B_negatif)==true) 
					{
					...
					//AB_NEGTAIF
					if(ff1.equals(Groupe_Sanguin.AB_negatif)==true) 
					{
